<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Advanced.aspx.cs" Inherits="ADInfo.Advanced" %>
    ...
    <script type="text/javascript"> 
        $(document).ready(function () {
            ...
            function getData() {
                ...
                var result = null;
                $.ajax({
                    url: 'ADUsersGetAdvanced.asmx/GetADUsers',
                    type: 'POST',
                    dataType: 'json',
                    async: false,
            ...
            var hot = new Handsontable(container, {
                ...
                colHeaders: ['ФИО', 'Логин', 'Должность', 'Подразделение', 'Организация', 'Телефон', 'Мобильный', 'E-mail', 'Комната', 'Город', 'Табельный', 'Создано ЦСУПД', 'УЗ включена', 'Путь к УЗ', 'УЗ создана', 'Предупреждение', 'Запрет отправки', 'Запрет приема', 'Последний АРМ', 'Последний вход', 'Срок действия УЗ', 'Пароль задан', 'Пароль истекает', 'УЗ заблокирована', 'IP АТС', 'Номер на АТС'],
                columnSorting: true,
                columns: [
                    {
                        data: 'FIO'
